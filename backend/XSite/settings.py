...
SECRET_KEY = "django-insecure-w=fh%^d^kwl$v9(t(c!@!d$7jtp)+*xsnimozh%u#aijz^5wmu"
...
LOGIN_REDIRECT_URL = "creator_subscriptions:profile"
LOGOUT_REDIRECT_URL = "creator_subscriptions:home"
...
SOCIALACCOUNT_PROVIDERS = {
    "twitter_oauth2": {
        ...
        "FIELDS": ["id", "name", "username", "verified", "profile_image_url"],
    },
}
...
X_SUBSCRIPTION_MOCK_TYPE = os.environ.get("X_SUBSCRIPTION_MOCK_TYPE", "Premium")
